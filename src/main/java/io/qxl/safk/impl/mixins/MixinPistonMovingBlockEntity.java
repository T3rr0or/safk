...
public abstract class MixinPistonMovingBlockEntity
{
	...
	private static PushReaction safk$moveShadowPlayer(Entity instance, Operation<PushReaction> original,
														   @Local(argsOnly = true) PistonMovingBlockEntity piston)
	{
		if (instance instanceof SafkServerPlayer && piston.getMovedState().is(Blocks.SLIME_BLOCK))
		{
