...
//#if MC >= 1.21.10
	...
	//$$ private Component safk$checkForStaleShadow(PlayerList instance, SocketAddress socketAddress,
														//$$ NameAndId nameAndId,
...
//#endif
		...
		SafkPlayerUtils.checkForSafkAtPreLogin(instance, profile, player);
