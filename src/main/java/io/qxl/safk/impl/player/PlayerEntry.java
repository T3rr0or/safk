...
@ApiStatus.Internal
public record PlayerEntry(UUID uuid, String name, SafkState state, PosState pos, GameState game)
{
	public PlayerEntry updateState(SafkState state)
	{
	...
	public PlayerEntry updateAll(SafkState state, PosState pos, GameState game)
	{
		return new PlayerEntry(this.uuid(), this.name(), state, pos, game);
	}

	public PlayerEntry updateAll(SafkState state, String name, PosState pos, GameState game)
	{
