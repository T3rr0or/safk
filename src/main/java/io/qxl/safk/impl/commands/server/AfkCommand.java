...
/**
 * Same behaviour as /safk, registered under the name players already know. Off by default, and
 * CommandRegister keeps it off when another AFK mod has claimed /afk.
 */
@ApiStatus.Internal
